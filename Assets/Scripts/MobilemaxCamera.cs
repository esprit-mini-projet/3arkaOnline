...
public class MobilemaxCamera : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        if(Input.touchCount == 2 && (IsPointerOneOverGameObject() || IsPointerTwoOverGameObject()))
        {
            return;
        } else if (Input.touchCount == 1 && IsPointerOneOverGameObject())
        {
            return;
        }
    ...
    public static bool IsPointerOneOverGameObject()
    {
        //check mouse
    ...
    public static bool IsPointerTwoOverGameObject()
    {
        //check mouse
        if (EventSystem.current.IsPointerOverGameObject())
            return true;
        ...
        {
            if (EventSystem.current.IsPointerOverGameObject(Input.touches[1].fingerId))
                return true;
        }
